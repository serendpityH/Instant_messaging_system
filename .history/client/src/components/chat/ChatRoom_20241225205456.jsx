...
const ChatRoom = () => {
  ...
  const handlePrivateMessage = async (message) => {
    try {
      console.log('处理接收到的私聊消息:', message);
      ...
      // 解密消息
      const decryptedMessage = cryptoService.decryptMessage({
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            {availableGroups.length > 0 ? (
              ...
              <p className="no-groups">无可加入的群��</p>
            )}
